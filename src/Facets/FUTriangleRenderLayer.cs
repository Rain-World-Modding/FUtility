...
{
    /// <summary>
    /// Derivative of <see cref="FTriangleRenderLayer"/> with more channels
    /// </summary>
    public class FUTriangleRenderLayer : FTriangleRenderLayer, IFURenderLayer
    {
        ...
        /// <param name="facetType">The facet type (should be <see cref="FUFacetTypes.FUTriangleType"/>)</param>
        /// <param name="atlas">The FAtlas to use</param>
        /// <param name="shader">The shader to use</param>
        protected internal FUTriangleRenderLayer(FStage stage, FFacetType facetType, FAtlas atlas, FShader shader) : base(stage, facetType, atlas, shader)
        {
        }
